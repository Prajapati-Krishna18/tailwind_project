      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <nav className="hidden md:flex items-center gap-1 ml-2">
            ...
            <div onClick={()=>navigate("/student/attendence")} className="px-3 py-2 text-sm text-neutral-300 hover:bg-neutral-800 rounded">
              Attendance
            </div>

            <div onClick={()=>navigate("/student/calender")}  className="px-3 py-2 text-sm text-neutral-300 hover:bg-neutral-800 rounded">
              Calendar
            </div>

            <div onClick={()=>navigate("/student/chat")} className="px-3 py-2 text-sm text-neutral-300 hover:bg-neutral-800 rounded">
              Chat
            </div>
            ...
            <div className="relative group">
              ...
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-150 absolute left-0 mt-2 w-48 rounded-lg border border-neutral-800 bg-neutral-900 shadow-xl">
                <div className="p-2 space-y-1">
                  ...
                  <div onClick={()=>navigate("/student/leave")} className="px-3 py-2 text-sm hover:bg-neutral-800 rounded">
                    Apply Leave
                  </div>
                </div>
              </div>
      ...
      {open && (
        <div className="md:hidden border-b border-neutral-800 bg-neutral-900/95 backdrop-blur px-4 sm:px-6 lg:px-8 py-3">
          <div className="max-w-7xl mx-auto flex flex-col gap-1">
            ...
            <div onClick={()=>navigate("/student/attendence")} className="px-3 py-2 hover:bg-neutral-800 rounded">
              Attendance
            </div>

            <div onClick={()=>navigate("/student/calender")} className="px-3 py-2 hover:bg-neutral-800 rounded">
              Calendar
            </div>

            <div onClick={()=>navigate("/student/chat")} className="px-3 py-2 hover:bg-neutral-800 rounded">Chat</div>
            ...
            <div onClick={()=>navigate("/student/leave")} className="px-3 py-2 hover:bg-neutral-800 rounded">
              Apply Leave
            </div>
